...
Mesh::Mesh(const std::vector<Vertex> &vertices, const std::vector<uint16_t> &indices, const std::vector<ModelTexture> &textures, glm::mat4 &transform, Material material)
{
